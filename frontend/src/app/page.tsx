      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
            What Content Would you like to
            <span className="text-blue-600"> Repurpose</span> today?
          </h1>

          <p className="text-xl text-gray-600 mb-12 max-w-2xl mx-auto">
            Transform your content into engaging posts for LinkedIn, Instagram,
            and <br />
          ...
          <div className="flex sm:flex-row gap-4 max-w-10vh mx-auto mb-16">
            ...
            <button
              className="px-6 py-6 text-sm bg-blue-600 hover:bg-blue-700
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex justify-center align-middle mt-[10vh]">
            <Button />
          </div>
        </div>
      </div>
